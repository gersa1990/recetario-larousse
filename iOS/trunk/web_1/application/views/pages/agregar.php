<div class="wrapper">
  ...
  <div id="myform" class="myform">
      ...
      <label for="app">Aplicación <span class="small">Id app</span></label>
      <select name="app" id="app">

        <?php foreach ($apps as $apps_item): ?>

          <option value="<?php echo $apps_item['id'] ?>"><?php echo $apps_item['nombre'] ?></option>
      ...
      <label for="video">Video <span class="small">Cargar file</span></label>

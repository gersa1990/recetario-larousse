<div class="wrapper">
    ...
    <a href="<?php echo base_url()."recetas/view/".$recetas_item['id'].'/'.$app; ?>" class="home">Ver Receta</a>

	<div id="receta">
		
		<div class="receta-pics">

			<img src="<?php echo base_url()."src/".$recetas_item['foto'] ?>" atl="">
		...
		<div class="receta-info">
			...
			<h3>Ingredientes</h3>
				<!-- <p><p> -->
				<textarea id="proce" class="nolinea" readonly><?php echo $recetas_item['ingredientes'] ?></textarea>
			...
			<h3>Modo de preparación</h3>
				...
				<!-- <p class="clear" > <p> -->
				<textarea  class="nolinea" readonly><?php echo $recetas_item['procedimiento'] ?></textarea>
		</div>

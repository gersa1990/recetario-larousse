<div class="wrapper">
	...
	<h1>Opciones de glosario</h1>

	<nav> 
      <ul>
        <li><a href="<?php echo base_url() ?>glosario/show/">Ver todo el glosario</a></li>
      </ul>
    </nav>
	...
	<div class="centrar">
			...
			<fieldset>
				...
				<br/>
				Descripcion<br/>
				<input type="text" class="input" name="descripcion" id="descripcion" cols="4" required>
				<br/><br/>
				Imagen<br/>
				<input type="text" class="input" name="imagen" id="imagen" cols="4" required>
				<br/><br/>
				<input type="submit" id="submitWordToGlosary" value="Agregar Palabra">
			</fieldset>
		</form>
	</div>
	<br/>
